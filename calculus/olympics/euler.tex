...
\begin{itemize}
    ...
    \item Esta prueba tiene preguntas cerradas y abiertas, solo es necesario justificar las preguntas
          abiertas.
    \item En caso de las preguntas abiertas asegúrese de señalar claramente la respuesta final.
    \item Las preguntas cerradas solo es necesario marcar la opción deseada.
    \item Los diagramas no están necesariamente dibujados a escala a no ser que se indique lo contrario.
    \item Se ofrecen únicamente como ayudas visuales.
...
\begin{enumerate}
    \item{¿Cuál es la razón del área del triángulo y el trapecio? \\ \begin{center}\begin{tikzpicture}
                  \coordinate (A) at (0,0);
                  \coordinate (B) at (1,2);
