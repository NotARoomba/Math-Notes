...
\author{Juan Andrés Del Toro R, Nathan Daniel Alspaugh y Juan Pablo Ortiz \\ Medio Ambiente, Colegio Real Royal School \\ Undécimo Grado \\ Lic. Corina Corpas Santofimio \\ 21 de mayo de 2025}
\date{}
\begin{document}
% --- Force page number on the first page (top right) ---
\makeatletter
...
\renewcommand{\maketitle}{
      ...
      \fancyhead[R]{\thepage} % Add page number at top right
}
\makeatother

\maketitle % Now includes the page number
\pagestyle{fancy}
\cfoot{}
...
{\normalfont\Large\bfseries\centering} % Font style for the section title
